...
GROUP_HELP = {
    ...
    "sip": "Inspect and monitor TKS-IP SIP client configuration.",
    "users": "Create or remove TKS-IP SIP monitoring accounts.",
...
PATH_SUPPORT: dict[tuple[str, ...], DeviceSupport] = {
    ...
    ("device", "diagnostics"): ALL_DEVICES,
    ("device", "factory-reset"): G1_X1,
    ("device", "info"): ALL_DEVICES,
    ("device", "restart"): G1_X1,
    ("firmware",): ALL_DEVICES,
    ("firmware", "check"): G1_X1,
    ("firmware", "upgrade"): ALL_DEVICES,
    ("gds",): G1,
    ("logging",): G1_X1,
    ("logs",): ALL_DEVICES,
    ("network",): ALL_DEVICES,
    ("network", "get"): ALL_DEVICES,
    ("network", "set"): G1_X1,
    ("ntp",): ALL_DEVICES,
    ("ntp", "get"): ALL_DEVICES,
    ("ntp", "set"): G1_X1,
